  ...
  */
  ...
  class EndpointRequest {
    ...
    */
    ...
    /**
    * Method called when a route is hit with a DEL request in testing, with a default mocked DEL response.
    * @param {function} callback Callback to be invoked on mock request. `callback(status, headers, body, json)`
    */
    ...
    /**
    * Method called when a route is hit with a POST request in testing, with a default mocked POST response.
    * @param {function} callback Callback to be invoked on mock request. `callback(status, headers, body, json)`
    */
